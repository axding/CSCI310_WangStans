...
public class LRecCenterFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavHostFragment.findNavController(LRecCenterFragment.this)
        ...
        binding.name.setText("Lyon Fitness");
        // End of Nav Bar
    ...
    private void readReservationFile(String date) {
        ...
        for(Map.Entry<String,?> entry : keys.entrySet()){
            ...
            if (dataVals[3].equals(date) && dataVals[0].charAt(0) == 'l') {
